  ...
  <body>
    <div class="container h-8 mx-auto p-5">
      <!--Navigation section awal-->
        <div class="md:flex md:flex-row md:justify-between text-center">
            ...
            <div class="mt-2">
                ...
                <a href="#" class="text-black-600 active-nav-link text-red-600 hover:text-red-600 p-1.5 md:p-4 font-bold" onclick="toggleDropdown1()">Product</a>
      ...
      <div class="container">
            ...
            <div class="container">
                <form action="/cariproduct" method="get">
                    @csrf
                    <div class="mb-3">
                        <label for="search" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Search</label>
                        <input type="text" name="cari" id="cariproduct" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="cari barang">
                    </div>
          ...
          <div class="shadow-lg rounded-lg">
            ...
            <div class="p-5">
              ...
              <div class="flex flex-row justify-between my-3">
                ...
                <a
                  href="#"
                  class="bg-gradient-to-r from-red-500 to-red-700 rounded-full py-4 px-1 text-gray-50 text-sm"
                >
                  <svg
                    version="1.1"
                    id="Layer_1"
