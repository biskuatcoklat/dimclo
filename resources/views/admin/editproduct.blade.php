        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <div class="leading-loose">
                    ...
                    @endif
                    <form class="p-10 bg-white rounded shadow-xl" action="/editlogicproduct/{{ $product->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="">
                            <label class="block text-sm text-gray-600" for="name">Product</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="title" name="title" type="text" required value="{{ $product->title }}">
                        </div>
                        <div class="mt-2">
                            <label class="block text-sm text-gray-600" for="name">Deskripsi</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="description" name="description" type="text" required value="{{ $product->description }}">
                        </div>
                        ...
                        <div class="mt-2">
                            ...
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="quantity" name="quantity" type="number" required value="{{ $product->quantity }}">
                        </div>
                        <div class="mt-2">
                            <label class="block text-sm text-gray-600" for="name">Price</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="price" name="price" type="number" required value="{{ $product->price }}">
                        </div>
                        <div class="mt-2">
                            <label class="block text-sm text-gray-600" for="name">Discount</label>
                            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="discount_price" name="discount_price" type="number" required value="{{ $product->discount_price}}">
                        </div>
                        <div class="mt-4">
